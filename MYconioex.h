 ...
 * @date    2021/01/21 (木) Myシリーズ関数を追加(上田直子)
 * @version	2.00
 */
#ifndef __CONIOEX_H
#define __CONIOEX_H
...
// 指定した座標位置にprintfする
//------------------------------------------------------
void GotoxyPrintf(int pos_x, int pos_y, const char* format, ...)
#ifdef CONIOEX
;
#else /* !CONIOEX */
{
...
// スクロール領域を設定
//-------------------------------------------------------------------
void MySetScrollMargin(int top, int bottom)
#ifdef CONIOEX
;
#else /* !CONIOEX */
{
